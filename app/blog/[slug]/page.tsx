  ...
  "biotina-para-cabello-dosis-beneficios": {
    ...
    content: (
      <>
        ...
        <p style={pStyle}>
          <strong>¿Por qué tanto?</strong> Porque la biotina es soluble en agua: lo que tu cuerpo no usa, lo eliminas por la orina. No se acumula. Por eso suele preferirse en presentaciones de mayor concentración, ya que el cuerpo regula lo que no utiliza.
        </p>
        ...
        <p style={pStyle}>
          ...
          <strong>10,000 mcg al día:</strong> presentación de alta concentración, para quienes buscan un mayor aporte de biotina en su rutina.
        </p>
        ...
        <p style={pStyle}>
          <strong>Spring Valley Biotina 10,000 mcg:</strong> 90 gomitas o 100 tabletas. Presentación de alta concentración para tu rutina de bienestar capilar.
        </p>
  ...
  "melatonina-5mg-vs-10mg-cual-elegir": {
    ...
    content: (
      <>
        ...
        <p style={pStyle}>
          <strong>10 mg:</strong> presentación de mayor concentración. La eligen personas con trabajo nocturno o que ya usaron presentaciones más bajas.
        </p>
        ...
        <p style={pStyle}>
          ...
          - Trabajas en turnos rotativos o nocturnos<br />
