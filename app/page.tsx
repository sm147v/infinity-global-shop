...
export default async function Home() {
  ...
  return (
    <div style={{ background: "#F7F1E5", fontFamily: "var(--font-dm-sans), Inter, sans-serif" }}>
        ...
        <div className="hero-grid" style={{
            ...
            <div style={{
              ...
              {[
                ...
                <div key={s.label} style={{
                  flex: 1,
                  textAlign: "center",
                  borderLeft: i > 0 ? "1px solid rgba(74, 93, 58, 0.1)" : undefined,
                }}>
                  <span style={{
                    fontFamily: "var(--font-fraunces), Georgia, serif",
                    fontSize: "1.3rem",
          ...
          <div className="hero-visual" style={{
            ...
            <div style={{
              ...
              width: "70%", height: "70%",
              borderRadius: 24,
              background: "linear-gradient(135deg, #A8B584 0%, #6B7B4F 70%, #4A5D3A 100%)",
              boxShadow: "0 20px 60px rgba(74, 93, 58, 0.2)",
            }} />
            <div style={{
              ...
              boxShadow: "0 20px 60px rgba(201, 123, 92, 0.2)",
              zIndex: 2,
            }} />
            <div style={{
              ...
              width: "30%", height: "30%",
              borderRadius: "50%",
              background: "radial-gradient(circle at 30% 30%, #E5D4A8 0%, #C9A96E 70%, #8B7140 100%)",
              boxShadow: "0 12px 32px rgba(201, 169, 110, 0.4)",
              zIndex: 3,
            }} />
          </div>
        </div>
      ...
      {/* RESEÑAS */}
      <section style={{ padding: "3rem 1.5rem", background: "#EDE3CD", maxWidth: "100%" }}>
        <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
          <div style={{ marginBottom: "2rem", textAlign: "center" }}>
            ...
            <h2 style={{
              ...
              Clientas <em style={{ fontStyle: "italic", fontWeight: 300, color: "#C97B5C" }}>encantadas</em>
            </h2>
          </div>
          ...
          <div className="reviews-grid">
            {[
              {
                stars: 5,
                quote: "Llegó al día siguiente, todo perfecto y empacado con tanto detalle. Las vitaminas son originales y me encanta el seguimiento por WhatsApp.",
                name: "María Camila R.",
                meta: "Compra verificada · El Poblado",
                avatar: "M",
              },
              {
                stars: 5,
                quote: "Por fin productos americanos sin pagar dólares ni esperar 3 semanas. Súper recomendadas, la atención es divina.",
                name: "Laura T.",
                meta: "Compra verificada · Laureles",
                avatar: "L",
              },
              {
                stars: 5,
                quote: "Compré para toda mi familia y todas las vitaminas son originales. El aceite de argán dejó mi cabello increíble.",
                name: "Sofía M.",
                meta: "Compra verificada · Envigado",
                avatar: "S",
              },
            ].map(r => (
              <div key={r.name} style={{
                ...
                <div style={{ color: "#C9A96E", marginBottom: "0.75rem", letterSpacing: "0.1em", fontSize: "1.1rem" }}>
                  {"★".repeat(r.stars)}
                </div>
                <p style={{
                  fontFamily: "var(--font-fraunces), Georgia, serif",
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                  <div style={{
                    width: 40, height: 40,
                    borderRadius: "50%",
                    background: "linear-gradient(135deg, #C97B5C, #C9A96E)",
                    display: "flex",
                    alignItems: "center",
                  ...
                  <div>
                    <div style={{ fontSize: "0.85rem", fontWeight: 600, color: "#2A2E26" }}>{r.name}</div>
                    <div style={{ fontSize: "0.7rem", color: "#4A4F45" }}>{r.meta}</div>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section style={{
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
          <h2 style={{
            ...
            Tu <em style={{ color: "#C9A96E", fontStyle: "italic", fontWeight: 300 }}>tranquilidad</em><br />
      ...
      <footer style={{
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
          ...
          <p style={{ fontSize: "0.9rem", opacity: 0.7, marginBottom: "1.5rem", maxWidth: "520px" }}>
