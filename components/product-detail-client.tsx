  ...
  return (
    <div style={{ background: "#F7F1E5", fontFamily: "var(--font-dm-sans), Inter, sans-serif", paddingBottom: "3rem" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "1rem 1.5rem" }}>
        ...
        <p style={{ fontSize: "0.72rem", color: "#8A8A7E", lineHeight: 1.5, margin: "1.5rem 0 0", textAlign: "center", maxWidth: 720, marginInline: "auto" }}>
          Los suplementos dietarios y productos cosméticos no son medicamentos y no están destinados a diagnosticar, tratar, curar ni prevenir enfermedades. La información de esta página es descriptiva y no sustituye la consulta con un profesional de la salud. Las marcas mencionadas son propiedad de sus respectivos titulares.
        </p>
